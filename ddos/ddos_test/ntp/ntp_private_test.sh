...
pcapname=yamldir=/home/tmp/module/ntp/
...
then
	...
	#cache test private_cache_check.yml
    python3 replay_test.py --yaml ${yamldir}private_cache_check.yml --pcap $pcapname 
else
	...
	#private Reflection Deny	
	python3 replay_test.py --yaml ${yamldir}private_reflect_pass.yml --pcap $pcapname 
